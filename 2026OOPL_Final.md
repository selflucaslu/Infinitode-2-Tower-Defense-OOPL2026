...
12. 第 1 關完成所有波次後會直接進入第 2 關。第 2 關以後完成一輪後會進入無限循環，敵人血量乘上 `1.2^loopCount`，速度乘上 `1.1^loopCount`；在 F1 啟用作弊模式後按 P 鍵或是完成第一輪循環後，若在第 1~4 關會顯示前往下一關按鈕，若在第 5 關則會顯示直接結束本局進入結算畫面的按鈕。
